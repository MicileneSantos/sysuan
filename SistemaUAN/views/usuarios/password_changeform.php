...
$this->title = Yii::t('app', "Alterar a senha do usuário"); 
...
<div class="col-xs-12 col-lg-12">
  <div class="<?php echo $model->isNewRecord ? 'box-success' : 'box-info'; ?> box view-item col-xs-12 col-lg-12">
	...
	<?= $form->field($model, 'password_hash')->passwordInput(['maxlength' => 60, 'placeholder' => $model->getAttributeLabel('password_hash')]) ?>
